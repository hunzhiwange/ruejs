...
pub fn main() -> iced::Result {
    ...
    let app = iced::application::timed(
        SolarSystem::new,
        SolarSystem::update_message,
    ...
    #[cfg(target_arch = "wasm32")]
    {
        ...
        window.platform_specific.target = Some("solar-system-wasm-app-container".to_string());
        return app.window(window).run();
    }
...
impl SolarSystem {
    ...
    fn update_message(&mut self, message: Message, now: Instant) {
        match message {
            Message::Tick => {
