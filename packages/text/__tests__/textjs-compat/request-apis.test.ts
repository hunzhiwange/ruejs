/**
 * Text.js Compatibility Tests: request-apis
 *
 * Ported from Text.js adapter-level behavior:
...
describe('Text.js compat: request-apis', () => {
  ...
  it('supports sync headers() and cookies() reads in a Server Component', async () => {
    const res = await fetch(`${baseUrl}/textjs-compat/request-api-sync`, {
      headers: {
  ...
  it('keeps headers() and cookies() read-only in Server Component render paths', async () => {
    const res = await fetch(`${baseUrl}/textjs-compat/request-api-readonly`, {
      headers: {
  ...
  it('allows sync cookies() mutation in route handlers', async () => {
    const res = await fetch(`${baseUrl}/textjs-compat/api/request-api-sync`, {
  ...
  it('keeps headers() read-only in route handlers', async () => {
    const res = await fetch(`${baseUrl}/textjs-compat/api/headers-readonly`, {
  ...
  it('supports iterator-based headers() access in route handlers', async () => {
    const res = await fetch(`${baseUrl}/textjs-compat/api/headers-iterate`, {
      headers: {
        'x-iterate-a': 'alpha',
        'x-iterate-b': 'beta',
      },
  ...
  it('supports mixed sync and awaited request API access in the same route handler', async () => {
    const res = await fetch(`${baseUrl}/textjs-compat/api/request-api-repeat`, {
