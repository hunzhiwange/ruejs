/**
 * Ported from Text.js's built-in default not-found component:
 *   https://github.com/vercel/next.js/blob/canary/packages/text/src/client/components/builtin/not-found.tsx
 *   https://github.com/vercel/next.js/blob/canary/packages/text/src/client/components/http-access-fallback/error-fallback.tsx
 *
 ...
 * Matches Text.js's `HTTPAccessErrorFallback` exactly: a centered 404 / message
 * pair with minified theme CSS and dark-mode media query.
 *
 * The message string `"This page could not be found."` (note the trailing
 * period) is the canonical body asserted by Text.js's deploy suite
...
} satisfies Record<string, RueStyle>
 ...
 * from Text.js. Kept in sync with the upstream component's structure so HTML
