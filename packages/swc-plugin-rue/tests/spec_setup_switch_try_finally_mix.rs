//! SWC 插件转换行为测试（spec_setup_switch_try_finally_mix）
//!
//! 覆盖：此用例的转换快照对比。
...
#[test]
fn switch_try_catch_finally_with_watch_mix() {
    let src = r##"
  ...
  switch (a.value) {
    case 0: {
      try {
        ...
        onBeforeUnmount(() => console.log('finally', a.value))
      }
      break
    }
    default: {
      watchEffect(() => console.log('case-default', a.value))
    }
  }
