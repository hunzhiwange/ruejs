...
const Comp: FC = ()=>{
    const _$useSetup = _$compiledWithHookId("useSetup:0:0", ()=>useSetup(()=>{
            ...
            watchEffect(()=>{
                    ...
                    onBeforeUnmount(()=>_$compiledWithHookId("watchEffect:1:2", ()=>watchEffect(()=>console.log('cleanup', a.value))));
                });
    ...
    const { a: a, info: info, __rue_phase2_info: __rue_phase2_info, assign: assign } = _$useSetup;
