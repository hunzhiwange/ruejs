...
import { ref, onMounted, onUnmounted, type FC } from 'rue-js'
...
```ts [mouse.ts]
import { ref, onMounted, onUnmounted } from 'rue-js'
...
```ts{7,12} [fetch.ts]
import { ref, watchEffect, toValue } from 'rue-js'
