...
在压力测试场景中，Rue 在 [js-framework-benchmark](https://krausest.github.io/js-framework-benchmark/current.html) 中相对于 React 和 Angular 有明显优势，同时也能与一些最快的非虚拟 DOM 生产级框架在基准中不相上下。
